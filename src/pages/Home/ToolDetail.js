...
const ToolDetail = () => {
    ...
    const { data: detail, isLoading, refetch } = useQuery('detail', () => fetch(`https://plumbing-manufacture.onrender.com/tool/${toolId}`).then(res => res.json()))
    ...
    const onSubmit = async data => {
        ...
        if (admin) {
            ...
            fetch(`https://plumbing-manufacture.onrender.com/order`, {
                method: 'POST',
                headers: {
                ...
                .then(data => {
                    ...
                    const url = `https://plumbing-manufacture.onrender.com/tool/${toolId}`
