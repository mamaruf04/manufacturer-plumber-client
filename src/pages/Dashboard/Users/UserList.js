...
const UserList = ({ user, index, refetch }) => {
    ...
    const makeAdmin = () => {
        const url = `https://plumbing-manufacture.onrender.com/user/admin/${email}`
        Swal.fire({
    ...
    const makeUser = () => {
        const url = `https://plumbing-manufacture.onrender.com/user/user/${email}`
        Swal.fire({
    ...
    const handleDelete = () => {
        const url = `https://plumbing-manufacture.onrender.com/user/${email}`;
        Swal.fire({
