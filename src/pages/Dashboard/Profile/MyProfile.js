...
const MyProfile = () => {
    ...
    const { data: myProfile, isLoading, refetch } = useQuery('profile', () => fetch(`https://plumbing-manufacture.onrender.com/profile/${email}`, {
        method: 'GET',
        headers: {
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch(`https://plumbing-manufacture.onrender.com/my-image/${myProfile._id}`, {
                        method: 'PUT',
                        headers: {
